...
public class MonthlyGroceryMapperImpl implements MonthlyGroceryMapper {
    ...
    public MonthlyGroceryDTO monthlyGroceryToMonthlyGroceryDTO(MonthlyGrocery monthlyGrocery) {
        ...
        Set<GroceryBasket> set = monthlyGrocery.getGroceryBasket();
        if ( set != null ) {
            monthlyGroceryDTO.setGroceryBasket( new HashSet<GroceryBasket>( set ) );
        }
    ...
    public MonthlyGrocery monthlyGroceryDTOToMonthlyGrocery(MonthlyGroceryDTO monthlyGroceryDTO) {
        ...
        Set<GroceryBasket> set = monthlyGroceryDTO.getGroceryBasket();
        if ( set != null ) {
            monthlyGrocery.setGroceryBasket( new HashSet<GroceryBasket>( set ) );
        }
